...
# Add to openpi/training/data_loader.py

def create_libero_hdf5_dataset(
    data_config: _config.DataConfig,
    action_horizon: int,
) -> Dataset:
...
def create_torch_dataset(
    ...
    """Create a torch dataset based on the data config."""
    ...
    if data_config.repo_id is None:
        ...
        return lerobot_dataset.LeRobotDataset(
            repo_id=data_config.repo_id,
            split="train",
            image_transforms=_transforms.lerobot_image_transforms(),
            delta_timestamps=_transforms.make_delta_timestamps(action_horizon),
        )