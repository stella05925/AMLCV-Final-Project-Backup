...
# In openpi/training/config.py

@dataclasses.dataclass(frozen=True)
class LeRobotLiberoVGGTDataConfig(DataConfigFactory):
    """LIBERO data config with precomputed VGGT features from local HDF5."""
    
    vggt_dataset_path: str = "/home/stella/projects/vggt/libero/datasets_with_vggt/libero_spatial"
    extra_delta_transform: bool = True
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_libero_vggt",
        
        model=pi0_config.Pi0WithVGGTConfig(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
            use_vggt_features=True,
            vggt_feature_dim=2048,
            vggt_compressed_dim=256,
            vggt_lora_rank=8,
        ...
        freeze_filter=pi0_config.Pi0WithVGGTConfig(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ).get_freeze_filter(),
